...
```json
{
  ...
  "includeTap" : true,
  "bsGitRepository" : "github.com?owner=stuartblackburnvmware&repo=node-express"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=stuartblackburnvmware&repo=node-express'
